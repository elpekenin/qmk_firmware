...
extern "C" bool xap_respond_data(xap_token_t token, const void *data, size_t length) { return true; }

extern "C" bool xap_respond_data_P(xap_token_t token, const void *data, size_t length) { return true; }

extern "C" bool xap_respond_success(xap_token_t token) { return true; }
...
extern "C" hardware_id_t get_hardware_id(void) { return hardware_id_t { { 0, 0, 0, 0} }; }
