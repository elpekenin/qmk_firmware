...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Quantum Painter LS0XX configurables (add to your keyboard's config.h)
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Quantum Painter LS0XX device factories

#ifdef QUANTUM_PAINTER_LS0XX_SPI_ENABLE
/**
 * Factory method for a generic LS0XX SPI MIP device.
 *
 ...
 * @param buffer[in] the array in which pixel data is stored
...
// Alias for known-working devices
#    define qp_ls013b7dh03_make_spi_device(cs, div, mode, buffer) qp_ls0xx_make_spi_device(128, 128, cs, div, mode, buffer)
